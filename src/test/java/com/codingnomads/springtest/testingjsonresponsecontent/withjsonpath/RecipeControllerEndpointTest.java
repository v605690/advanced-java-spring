...
import com.codingnomads.springtest.testingjsonresponsecontent.RecipeMain;
...
public class RecipeControllerEndpointTest {
    ...
    public void testUpdateRecipeSuccessBehavior() throws Exception {
        ...
        recipeToUpdate
                .getReviews()
                .add(Review.builder()
                        .description("Was pretty good. A lil spicy though")
                        .username("ben")
                        .rating(5)
                        .build());
        recipeToUpdate
                ...
                .add(Step.builder()
                        .stepNumber(1)
                        .description("put tabasco on plate")
                        .build());
        recipeToUpdate
                .getSteps()
                .add(Step.builder().stepNumber(2).description("lick plate").build());

        recipeToUpdate
                .getIngredients()
                .add(Ingredient.builder().name("Tabasco").amount("5 tbs").build());
    ...
    public void testDeleteRecipeByIdSuccessBehavior() throws Exception {
        ...
        mockMvc.perform(delete("/recipes/" + recipeId))
                ...
                // expect the body is
                .andExpect(jsonPath("$")
                        .value("The recipe with ID " + recipe3.getId() + " and name " + recipe3.getName()
                                + " was deleted"));
    }
