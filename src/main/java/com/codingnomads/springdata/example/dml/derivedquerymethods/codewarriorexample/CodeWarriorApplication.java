...
public class CodeWarriorApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        final EmailAddress java_ninja =
                EmailAddress.builder().emailAddress("java@ninja.com").build();
        final EmailAddress java_guru =
                EmailAddress.builder().emailAddress("java@guru.com").build();
        final EmailAddress spring_guru =
                EmailAddress.builder().emailAddress("spring@guru.com").build();
        final EmailAddress spring_ninja =
                EmailAddress.builder().emailAddress("spring@ninja.com").build();
        ...
        final CodeWarrior byEmailAddressAndLastName =
                codeWarriorRepo.findByEmailAddressAndLastName(emailAddress, "Ninja");
        ...
        final List<CodeWarrior> byLastNameAndFirstNameAllIgnoreCase =
                codeWarriorRepo.findByLastNameAndFirstNameAllIgnoreCase("gUrU", "jAvA");
        byLastNameAndFirstNameAllIgnoreCase.forEach(System.out::println);

        System.out.println(
                "***************************************************findByLastNameOrderByFirstNameAsc***************************************************");
        final List<CodeWarrior> byLastNameOrderByFirstNameAsc =
                codeWarriorRepo.findByLastNameOrderByFirstNameAsc("Guru");
        byLastNameOrderByFirstNameAsc.forEach(System.out::println);

        System.out.println(
                "***************************************************findByLastNameOrderByFirstNameDesc***************************************************");
        final List<CodeWarrior> byLastNameOrderByFirstNameDesc =
                codeWarriorRepo.findByLastNameOrderByFirstNameDesc("java");
        byLastNameOrderByFirstNameDesc.forEach(System.out::println);

        System.out.println(
                "***************************************************findByEmailAddress_EmailAddress***************************************************");
        final CodeWarrior byEmailAddress_emailAddress =
                codeWarriorRepo.findByEmailAddress_EmailAddress("java@ninja.com");
