/* CodingNomads (C)2024 */
package com.codingnomads.springdata.lab_complete;
...
import com.codingnomads.springdata.lab_complete.repositories.AreaRepository;
import com.codingnomads.springdata.lab_complete.repositories.PointOfInterestRepository;
import com.codingnomads.springdata.lab_complete.repositories.RouteRepository;
    ...
    public void run(String... args) throws Exception {
        ...
        if (routeRepository.findAll().size() == 0) {
            final List<Route> routes = routeRepository.saveAll(Arrays.asList(
                    Route.builder()
                            .origin(areaRepository.findByCode("L"))
                            .destination(areaRepository.findByCode("O"))
                            .build(),
                    Route.builder()
                            ...
                            .build(),
                    Route.builder()
                            .origin(areaRepository.findByCode("H"))
                    ...
                    Route.builder()
                            ...
                            .destination(areaRepository.findByCode("A"))
                            .build(),
                    Route.builder()
                            .origin(areaRepository.findByCode("H"))
                            .destination(areaRepository.findByCode("Z"))
        ...
        if (pointOfInterestRepository.findAll().size() == 0) {
            ...
            PointOfInterest poi4 = new PointOfInterest("Restaurant", "Nirmanz", areaRepository.findByCode("L"));
            ...
            PointOfInterest poi5 = new PointOfInterest("Roadside Attraction", "Ufo", routeRepository.findByCode("B-A"));
            PointOfInterest poi6 =
                    new PointOfInterest("Roadside Attraction", "Waterfall", routeRepository.findByCode("H-Y"));

            final List<PointOfInterest> poiList =
                    pointOfInterestRepository.saveAll(List.of(poi1, poi2, poi3, poi4, poi5, poi6));
        }
