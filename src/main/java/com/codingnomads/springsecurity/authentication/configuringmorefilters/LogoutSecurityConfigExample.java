/* CodingNomads (C)2023 */
package com.codingnomads.springsecurity.authentication.configuringmorefilters;
...
public class LogoutSecurityConfigExample {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .formLogin(login -> login.loginPage("/sign-in").defaultSuccessUrl("/homepage"))
                ...
                .logout(logout -> logout.logoutUrl("/sign-out").logoutSuccessUrl("/sign-in"));
